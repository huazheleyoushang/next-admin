...
const TableHeader = ({ className, ...props }: React.ThHTMLAttributes<HTMLTableSectionElement>) => (
  <thead className={cn("[&_tr]:border-b", className)} {...props} />
);
TableHeader.displayName = "TableHeader";

const TableBody = ({ className, ...props }: React.TdHTMLAttributes<HTMLTableSectionElement>) => (
